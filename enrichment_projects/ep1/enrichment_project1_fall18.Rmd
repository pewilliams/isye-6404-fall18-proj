...
Second, Suppose there are g groups obey normal distribution with possibly different means and standard deviations $σ_1, σ_2,…, σ_g$. Let $n_1, n_2, …, n_g$ denote the number of subjects in each group, $Y_{ki}$ denote response values, and N denote
...
'''
As we can see, there are many points don't fall approximately along this reference line, so, we can not assume normality.
