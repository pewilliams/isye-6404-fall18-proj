...
tdat = tdat[,!names(tdat) %in% c("Patient")]    # Removing extra Varialbe
...
```{r flignertest_wine, echo = F, include = T}
...
\begin{tabular}{ |l|l|c| } 
\hline
Team Member & Task Description & Distribution \\
\hline
Yuan Gao & Sections 1.4 \& 1.6 Code Compilation & cell \\ 
Kevin Lee & Description of transformed data, Sections 1.2 \& 1.5 & cell \\ 
Akshay Govindaraj & cell & cell \\ 
Yijun (Emma) Wan & cell & cell \\ 
Peter Williams & Proj. Management, Sections 1.1-1.3 Code Compilation, Debugging & 16 \\ 
Ruixuan Zhang & cell8 & cell \\ 
\hline
\end{tabular}
\end{center}
