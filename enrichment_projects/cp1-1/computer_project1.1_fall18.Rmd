...
Based on the preset distribution and acceleration factor, it is possible to compute the full likelihood:
...
where $S_{0}(\epsilon_i)$ is called “baseline survival function” and $f_{0}(\epsilon_i)$ is the corresponding probability density function. Here, $S_{1}(t)=S_{0}({\gamma}t)$.
