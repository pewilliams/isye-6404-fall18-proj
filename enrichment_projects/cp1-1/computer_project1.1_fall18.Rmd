...
results <- do.call('rbind',lapply(variables, function(x){
...
knitr::kable(results, caption = 'Model Results - Add a Better Title')

#old code example
# res.cox.age <- coxph(formula = as.formula("Surv(time, status) ~ age"), data = kidney)
# res.cox.age
# res.cox.zph.age <- cox.zph(res.cox.age)
# res.cox.zph.age
```
