...
Use the above bootstrap standard errors for our confidence interval for the "age" effect estimate and the bootstrap mean given alongside the standard error estimates. This leads us to the following confidence intervals through the above equation [ beta-est. +- 1.645*s.e.(beta-est.):
