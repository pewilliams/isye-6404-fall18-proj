...
```{r comparions_plot, include = T, echo = F, fig.align='center',fig.height=4}
ggplot() + 
...
```{r Loess_Comparison, echo =F, include = T, fig.align='center',fig.height=4}
...
Nadaraya-Watson: $Bias{f(x_0)} = f_0(x_0)\sum_{i}wi(x_i - x_0) + O(h^2)$, where $w_i = K_h(x_i,x_0)/\sum_{j}K_h(x_j,x_0)$  
...
Other comments and comparisons for kernel,  nearest neighbor methods, and spline regressions include:
